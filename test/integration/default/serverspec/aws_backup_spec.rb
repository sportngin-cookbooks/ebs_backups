...
describe cron do
  ...
  it { should have_entry(%Q{5 * * * 6 land before time && /home/ec2-user/automated-backup.sh -t "All,Values=true" -k 30 && happily ever after || epic fail >> /var/log/ebs_backups.log 2>&1}).with_user('ec2-user') }
end
